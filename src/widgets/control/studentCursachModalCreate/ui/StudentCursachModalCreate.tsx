...
import {setTableDataCreateStudentCursach, updateTableDataCursach} from "@/features/diplomWork/slice/slice";
import {studentsReplace, studetnCursachCreate} from "@/features/diplomWork/action/action";
...
const StudentCursachModalCreate: React.FC<WorkerCreateModalProps> =
    ({
         setOpen,
         selectedItem,
        titlePage
        ...
        const tableData = useAppSelector((state: RootState) => state.cursach.tableData)
        ...
        const submitCreate = (e: React.FormEvent) => {
            ...
            dispatch(studetnCursachCreate(newEntry))
        ...
        const submitEdit = (e: React.FormEvent) => {
            ...
            tableData.map((item:Person) => {
                if (item.id === selectedItem.id) {
                    dispatch(updateTableDataCursach({
                        id: item.id,
                        title: title,
                        fio: fio,
                        prepodFio: prepodFio,
                            ...
                            <div className="student__modal__form__content">
                                ...
                                <div className="student__modal-block">
                                    <input
                                        ...
                                        className="student__modall__input"
                                        type="text"
...
export default StudentCursachModalCreate;